...
class RobotStates:
    ...
    def Update(TEMP,RAD,TIKS,GRAD,TOOLPOSE, tool):
        ...
        RobotStates.UI.ActualTool.setTexts(str(round(TOOLPOSE[0],2)) + "\t" + str(round(TOOLPOSE[1],2)) + "\t" + str(round(TOOLPOSE[2],2)) + "\t" + str(round(TOOLPOSE[3],2)) + "\t" + str(round(TOOLPOSE[4],2)) + "\t" + str(round(TOOLPOSE[5],2)))
        if tool:
